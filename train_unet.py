...
if __name__ == '__main__':
    ...
    trainset = RUGD(root_dir='E:\DL\Final Project\RUGD', split='train', transform=transform)
    testset = RUGD(root_dir='E:\DL\Final Project\RUGD', split='test', transform=transform)
    ...
    for epoch in range(num_epochs):
        ...
        for images, labels in trainloader:
            ...
            loss = criterion(outputs, torch.squeeze(predicted, dim=1))  # use predicted class as label
            loss.backward()
            optimizer.step()
